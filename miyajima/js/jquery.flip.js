...
(function($) {
  ...
  var getTransparent = function(el){
  		for(var n=0;n<el.parents().length;n++){
			...
			var pBg = $(parent).css("background-color");
	...
	return this.each( function() {
		...
		var dirOptions = {
			...
			"lr": {
				...
				"first": {borderTopWidth: (flipObj.height/100)*10,borderLeftWidth: '0px',borderRightWidth: '0px',borderBottomWidth: (flipObj.height/100)*10,borderTopColor: flipObj.transparent,borderBottomColor: flipObj.transparent,borderLeftColor: '#ddd',borderRightColor: '#ddd',top: flipObj.top-(flipObj.height/100)*10,left: flipObj.left+(flipObj.width/2)},
